...
(function () {
  ...
  function screenImport() {
    ...
    mount(
      ...
      '<h2>העלאת ייצוא של קבוצת ווטסאפ</h2>' +
      '<p class="muted">בווטסאפ: פרטי הקבוצה ← ייצוא צ׳אט ← <strong>צירוף מדיה</strong>. ' +
      'בלי צירוף מדיה לא יגיעו קבצי אנשי הקשר ולא יהיו מספרי טלפון.</p>' +
